...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Java\\Kurs\\MusicUI\\" + DB_NAME;
    ...
    public static final String QUERY_ALBUMS_BY_ARTIST_ID = "SELECT * FROM " + TABLE_ALBUMS + " WHERE " + COLUMN_ALBUM_ARTIST + " = ? ORDER BY " + COLUMN_ALBUM_NAME;

    public static final String UPPDATE_ARTIST_NAME = "UPDATE " + TABLE_ARTISTS + " SET " + COLUMN_ARTIST_NAME + " = ? WHERE " + COLUMN_ARTIST_ID + " = ?";
    ...
    public boolean open() {
        try {
            ...
            updateArtistName = conn.prepareStatement(UPPDATE_ARTIST_NAME);
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            try {
                ...
                System.out.println("Niedobrze" + e2.getMessage());
            }
        } finally {
            try {
                System.out.println("Resseting default");
                conn.setAutoCommit(true);
            } catch (SQLException e) {
                System.out.println("No autocommit " + e.getMessage());
            }
        }
    }
}
